 ...
 */
package com.zhaimi.message.event.binding;

import com.zhaimi.message.demo.member.mapper.Member;
import com.zhaimi.message.event.DataEvent;
 ...
 */
@Component
@DataListener(dataObject = "com.zhaimi.message.demo.member.mapper.impl.MemberMapperImpl")
