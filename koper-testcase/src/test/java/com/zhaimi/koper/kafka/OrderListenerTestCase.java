 ...
 */
package com.zhaimi.koper.kafka;
...
public class OrderListenerTestCase extends AbstractMessageListener {
    ...
    private final String topic = "com.zhaimi.message.listener.OrderListenerTestCase";
    ...
    @Listen(topic = "com.zhaimi.message.listener.OrderListenerTestCase")
    @Override
