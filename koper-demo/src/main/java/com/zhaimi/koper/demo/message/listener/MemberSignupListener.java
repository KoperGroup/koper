 ...
 */
package com.zhaimi.koper.demo.message.listener;

import com.zhaimi.koper.AbstractMessageListener;
import com.zhaimi.koper.Listen;
import com.zhaimi.koper.demo.message.service.SmsService;
...
public class MemberSignupListener extends AbstractMessageListener {
    ...
    @Listen(topic = "com.zhaimi.koper.demo.message.notifyMemberAfterSignup")
    @Override
